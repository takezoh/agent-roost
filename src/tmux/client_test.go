...
func TestParseRoostWindows(t *testing.T) {
	...
	// tags, @roost_agent_pane, @roost_driver_state, @roost_state,
	...
	out := "@1\tabc123\t/tmp/proj\tclaude\t2026-04-08T12:00:00Z\t[]\t\t\trunning\t2026-04-08T12:00:05Z\n" +
		...
		"@3\tdef456\t/tmp/other\tclaude --worktree\t2026-04-08T12:01:00Z\t[{\"text\":\"main\"}]\t%5\t" + driverState + "\twaiting\t2026-04-08T12:30:00Z\n"
...
func TestParseRoostWindows_TooFewFields(t *testing.T) {
	...
	// Pre-AgentPaneID 9-field format should now be skipped (10 fields required).
